const HeroBanner = () => {
  return (
    <section className="relative bg-cover bg-center h-[60vh] flex items-center justify-start text-white" style={{ backgroundImage: "url('hero-background.jpg')" }}>
      <div className="bg-black/60 p-8 rounded-md max-w-md mx-4">
